...
export default function Claims() {
  ...
  const { paged, page, setPage, total, pageCount } = usePagedList(items, search, [(c) => c.claimReference, (c) => personName(c.patient), (c) => c.patient?.mrn]);
